...
class CommentController extends GetxController {
  ...
  Future<void> loadComments(String postId) async {
    ...
    try {
      ...
      final loadedComments = await _communityRepository.fetchComments(postId);
  ...
  Future<void> _loadReplies(String parentCommentId) async {
    ...
    try {
      final replies = await _communityRepository.fetchReplies(parentCommentId);
      if (_isDisposed) return;
  ...
  Future<bool> addComment(String postId, {String? parentCommentId}) async {
    ...
    try {
      ...
      final commentId = await _communityRepository.addComment(comment);
  ...
  Future<bool> deleteComment(String commentId, String postId) async {
    ...
    try {
      final success = await _communityRepository.deleteComment(
        commentId,
        postId,
      );
      if (_isDisposed) return false;
