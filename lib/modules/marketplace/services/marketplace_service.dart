...
/// MarketplaceService — All Firestore operations for marketplace
class MarketplaceService extends GetxService {
  ...
  Future<List<ProductModel>> fetchProducts({
    ...
    try {
      ...
      debugPrint('[MarketplaceService] fetchProducts error: $e');
      rethrow;
    }
  }
  ...
  Future<String> createProduct(ProductModel product) async {
    ...
    debugPrint('[MarketplaceService] Product created: ${ref.id}');
    return ref.id;
  }
  ...
  Future<String> createOrder(OrderModel order) async {
    ...
    debugPrint('[MarketplaceService] Order created: ${ref.id}');
    return ref.id;
  }
